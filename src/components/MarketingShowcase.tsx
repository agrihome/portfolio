          ...
          <div className="relative overflow-hidden bg-black/40 p-8 lg:p-16 flex items-center justify-center min-h-[400px]">
            <AnimatePresence mode="wait">
              ...
              <motion.img
                ...
                className="w-[240px] h-[497px] sm:w-[280px] sm:h-[580px] object-cover rounded-[30px] sm:rounded-[40px] shadow-2xl border-[6px] border-white/10 relative z-10 shrink-0"
              />
            </AnimatePresence>
